...
resourcename="timetrackingbillingappiter1"  # lower case, only
resourcegroup="timetrackingbillingappiter1_rg"
...
# git clone https://github.com/apilogicserver/timetrackingbillingappiter1.git
# cd timetrackingbillingappiter1
...
az group create --name timetrackingbillingappiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group timetrackingbillingappiter1_rg --sku S1 --is-linux
az container create --resource-group timetrackingbillingappiter1_rg --name timetrackingbillingappiter1 --image apilogicserver/timetrackingbillingappiter1:latest --dns-name-label timetrackingbillingappiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//timetrackingbillingappiter1.westus.azurecontainer.io:5656'
